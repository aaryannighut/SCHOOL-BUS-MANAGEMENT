// Sample Data
const routes = [
    { id: "RT-1001", cities: "City A, City B", bus: "Bus 101", date: "2023-01-01", time: "10:00 AM", cost: "$100" },
    { id: "RT-1002", cities: "City C, City D", bus: "Bus 202", date: "2023-01-02", time: "2:00 PM", cost: "$120" }
];
...
function loadRoutes() {
    ...
    routes.forEach((route, index) => {
        ...
        row.innerHTML = `
            ...
            <td>${route.cost}</td>
            <td>
                <button class="edit" onclick="editRoute(${index})">EDIT</button>
                <button class="delete" onclick="deleteRoute(${index})">DELETE</button>
            </td>
        `;
